<?php
	$translations = [
		'en' => [
			...
			'blank'               => 'blank',
			'can leave empty'     => 'Questions that you leave blank are not shown on the survey.',
			...
			'creation info'       => "After clicking 'create', you will be given a public code (to give your audience, valid for 2 weeks) and a private code (to view the results).\n"
			                       . "If you want to email these to yourself, enter your email address here. The address will be used once and is not stored.",
			'Email address'       => 'Email address',
			'(optional)'          => '(optional)',
			'A link'              => 'A link, e.g. a project website or social media profile',
		...
		'de' => [
			...
			'blank'               => 'leer',
			'can leave empty'     => 'Fragenfelder, die Sie leer lassen, werden in die Umfrage nicht angezeigt.',
			...
			'creation info'       => "Mit Klick auf 'Erstellen' wird Dein Feedback-Formular veröffentlicht. Es ist für 14 Tage gültig.\n"
			                       . "Wenn Sie diese an sich selbst senden möchten, geben Sie hier Ihre E-Mail-Adresse ein. Die Adresse wird einmalig verwendet und nicht gespeichert.",
			'Email address'       => 'E-Mail-Adresse',
			'(optional)'          => '(optional)',
			'A link'              => 'Weiterführender Link z.B. zur Projektwebsite, Social-Media-Account ...',
		...
		'nl' => [
			...
			'blank'               => 'blanco',
			'can leave empty'     => 'Blanco vragen worden niet meegenomen in het feedbackformulier.',
			...
			'creation info'       => "Nadat je op aanmaken klikt, krijg je een publiekscode (om aan jouw publiek te geven, geldig voor twee weken) en een code om de resultaten in te zien.\n"
			                       . "Als je deze aan jezelf wil e-mailen, vul dan je e-mailadres hier in. Het adres wordt eenmalig gebruikt en niet opgeslagen.",
			'Email address'       => 'E-mailadres',
			'(optional)'          => '(optioneel)',
			'A link'              => 'Een link, bijvoorbeeld de projectwebsite of socialmedia-account',
